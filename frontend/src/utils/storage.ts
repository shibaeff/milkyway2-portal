import type { LocalValidatorEntriesData, NetworkId, Validator } from '../types';
...
export const setLocalFavorites = (network: NetworkId, favorites: string[]) => {
  localStorage.setItem(`${network}_favorites`, JSON.stringify(favorites));
}; 